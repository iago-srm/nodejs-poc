...
export const Portuguese = {
  ...
  [UserMessageNames.USERNAME.INVALID_LENGTH]: "Must have min 4 and max 32 characters.",
  ...
  [UserMessageNames.PASSWORD.INVALID_LENGTH]: "Password must be between 6 and 32 characters.",
  [UserMessageNames.PASSWORD.INVALID_PATTERN]: "PT Password must have at least 1 uppercase, 1 lowercase letter and 1 number.",
}
